...
import 'package:movie_finder/bloc/get_casts_bloc.dart';
            ...
            child: GestureDetector(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    casts[index].name, maxLines: 2 ,style: TextStyle(
                      height: 1.4,
                      color: Colors.white,
                  ...
                  Text(
                    casts[index].character,textAlign: TextAlign.center, style: TextStyle(
                      color: Style.Colors.titleColor,
                      fontWeight: FontWeight.bold,
                      fontSize: 7.0,
